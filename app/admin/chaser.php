...
$sql = "SELECT * FROM custorder WHERE chaser='y' AND CONCAT_WS('|',`username`,`orderref`,`postcode`,`eventdate`) LIKE '%".$term."%'"; 
...
while ($row = mysql_fetch_array($r_query)){  
 $checkdelete = $row["deleted"];
  ...
  $strSQL = "SELECT * FROM custorder WHERE chaser='y'";
  ...
  while($row = mysql_fetch_array($rs)) {
    ...
    echo "<td><a href='singleestimate.php?orderref=" . $row['orderref'] . "'><i class='fa fa-search'></i> View</a></td>";
    echo "<td class='text-center'>";
  if($checkdelete != 'y'){ echo '<a href="chaser.php?delete='. $row['orderref'] .' "> <i class="fa fa-times"></i></a></td>';} 
  else { echo '<a href="chaser.php?deleteno='. $row['orderref'] .' "> <i class="fa fa-check"></i></a></td>';}
    echo "</tr>";
    }
  }
?>
