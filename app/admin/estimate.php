...
<div class="container estimate-container-main">
...
<form id="marquee-jquery-order-form" class="jof form-horizontal" action="formdbsubmit-new.php" method="get">
...
echo "<div class=\"col-md-1 col-sm-1 col-xs-12 hidden-xs helpdiv\"><a data-toggle=\"modal\"  data-target=\"#". $row["identifier"] ."help\"><span class=\"glyphicon glyphicon-question-sign\"></span></a></div>";
echo "</div>";
...
<!-- SCRIPTS -->
    ...
    <script src="/assets/js/jquery-price-calculator-pro.min.js"></script> 
    <script src="/assets/js/pricetable-new.js"></script>
