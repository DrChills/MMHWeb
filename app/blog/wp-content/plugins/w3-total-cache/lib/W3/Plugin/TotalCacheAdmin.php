...
<script type="text/javascript">
    ...
    <style type="text/css" media="screen">
        #toplevel_page_w3tc_dashboard .wp-menu-image {
            background: url(<?php echo plugins_url('w3-total-cache/pub/assets/img/w3tc-sprite.png')?>) no-repeat 0 -32px !important;
        }
        ...
        #icon-edit.icon32-posts-casestudy {
            background: url(<?php echo plugins_url('w3-total-cache/pub/assets/img/w3tc-sprite.png') ?>) no-repeat;
        }
        /**
        * HiDPI Displays
        */
        ...
        (min-resolution: 120dpi) {
            ...
            #toplevel_page_w3tc_dashboard .wp-menu-image {
                background-image: url(<?php echo plugins_url('w3-total-cache/pub/assets/img/w3tc-sprite-retina.png')?>) !important;
