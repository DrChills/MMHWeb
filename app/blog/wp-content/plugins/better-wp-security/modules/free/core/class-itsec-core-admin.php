...
class ITSEC_Core_Admin {
	...
	public function metabox_get_backupbuddy() {
		...
		echo '<p style="text-align: center;"><img src="' . plugins_url( 'assets/img/backupbuddy-logo.png', __FILE__ ) . '" alt="BackupBuddy"></p>';
	...
	public function metabox_get_started() {
		...
		echo '<a class="itsec-video-link" href="#" data-video-id="itsec_video"><img src="' . plugins_url( 'assets/img/video.png', __FILE__ ) . '" /></a>';
		...
		<div id="mc_embed_signup">
			<form
				...
				<div style="text-align: center;">
					<img src="<?php echo plugins_url( 'assets/img/security-ebook.png', __FILE__ ) ?>" width="145"
	...
	public function metabox_sync_integration() {
		...
		?>
		<div style="text-align: center;">
			<img src="<?php echo plugins_url( 'assets/img/sync-logo.png', __FILE__ ) ?>" width="173"
